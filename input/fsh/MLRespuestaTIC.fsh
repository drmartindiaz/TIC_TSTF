...
* entidadRespondedora 1..1 Reference(PractitionerRole) "Responsables que responden la TICTF"
  * profesionalRespondedor 1..1 Reference(Practitioner) "Profesional que recibe y responde la TICTF"
  * institucionRespondedora 1..1 Reference(Organization) "Institución que recibe y responde la TICTF"
  * paisReceptor 1..1 Reference(Location) "País que recibe la TITF"
